...
const forumKey = "topics_forum_ajankohtaistapalsta"; // Change this for different forums
    ...
    function loadTopics() {
        ...
        topics.forEach((topic, index) => {
            ...
            topicDiv.innerHTML = `
                ...
                <div class="subjects">
                    <a href="ajankohtaistakeskustelu.html?index=${index}&forumKey=${forumKey}">${topic.title}</a><br>
