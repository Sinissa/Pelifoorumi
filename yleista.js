...
const forumKey = "topics_forum_yleistapalsta"; // Change this for different forums
    ...
    function loadTopics() {
        ...
        topics.forEach((topic, index) => {
            ...
            topicDiv.innerHTML = `
                ...
                <div class="subjects">
                    <a href="yleistakeskustelu.html?index=${index}&forumKey=${forumKey}">${topic.title}</a><br>
